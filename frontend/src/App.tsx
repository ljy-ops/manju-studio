...
export default function App() {
  ...
  // Canvas Drop Zone (drag files from desktop to create nodes)
  const {
    dropFeedback,
    handleDragEnter,
    handleDragOver,
    ...
    <div className={`w-screen h-screen ${canvasTheme === 'dark' ? 'bg-[#050505] text-white' : 'bg-neutral-50 text-neutral-900'} overflow-hidden select-none font-sans transition-colors duration-300`}>
      ...
      {dropFeedback.isActive && (
        <div className="fixed inset-0 pointer-events-none z-[999] flex items-center justify-center">
          ...
          <div className="relative bg-blue-600/90 text-white px-8 py-6 rounded-2xl shadow-2xl border-2 border-blue-400">
            <div className="flex items-center gap-4">
              <svg className="w-12 h-12" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
              </svg>
              <div>
                <div className="text-xl font-bold">释放以创建节点</div>
                <div className="text-sm text-blue-100 mt-1">支持图片和视频文件</div>
              </div>
            </div>
          </div>
        </div>
