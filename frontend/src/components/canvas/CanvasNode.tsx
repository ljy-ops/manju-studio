...
import { ComfyUITaskNode } from './ComfyUITaskNode';
...
export const CanvasNode: React.FC<CanvasNodeProps> = ({
  ...
  // Special rendering for AI Manga nodes
  if (data.type === NodeType.SCRIPT) {
    return (
      ...
      >
        ...
        <ScriptNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }

  if (data.type === NodeType.CHARACTER) {
    return (
      <div
        className={`absolute flex items-center group/node touch-none pointer-events-auto`}
        style={{
      ...
      >
        <NodeConnectors nodeId={data.id} onConnectorDown={onConnectorDown} canvasTheme={canvasTheme} />
        <CharacterNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }

  if (data.type === NodeType.SCENE) {
    return (
      <div
        className={`absolute flex items-center group/node touch-none pointer-events-auto`}
        style={{
      ...
      >
        <NodeConnectors nodeId={data.id} onConnectorDown={onConnectorDown} canvasTheme={canvasTheme} />
        <SceneNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }

  if (data.type === NodeType.SHOT) {
    return (
      <div
        className={`absolute flex items-center group/node touch-none pointer-events-auto`}
        style={{
      ...
      >
        <NodeConnectors nodeId={data.id} onConnectorDown={onConnectorDown} canvasTheme={canvasTheme} />
        <ShotNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }
  ...
  if (data.type === NodeType.PROMPT) {
    return (
      ...
      >
        <NodeConnectors nodeId={data.id} onConnectorDown={onConnectorDown} canvasTheme={canvasTheme} />
        <PromptNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }

  if (data.type === NodeType.EDIT) {
    return (
      <div
        className={`absolute flex items-center group/node touch-none pointer-events-auto`}
        style={{
      ...
      >
        <NodeConnectors nodeId={data.id} onConnectorDown={onConnectorDown} canvasTheme={canvasTheme} />
        <EditNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }

  if (data.type === NodeType.COMFYUI_TASK) {
    return (
      <div
        className={`absolute flex items-center group/node touch-none pointer-events-auto`}
        style={{
      ...
      >
        <NodeConnectors nodeId={data.id} onConnectorDown={onConnectorDown} canvasTheme={canvasTheme} />
        <ComfyUITaskNode node={data} onUpdate={onUpdate} onDelete={() => {/* handled by parent */}} />
      </div>
    );
  }
