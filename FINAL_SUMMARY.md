...
| **AI Agent** | `agent.ts` | 剧本Agent + 生产Agent HTTP接口 |

### 2. 前端节点组件 (9个)

| 节点 | 文件 | 功能 | Agent集成 |
|------|------|------|-----------|
| 剧本节点 | `ScriptNode.tsx` | 剧本信息展示、生成、编辑 | ✅ 剧本Agent |
| 角色节点 | `CharacterNode.tsx` | 角色信息、多形象、表情生成 | ✅ 剧本Agent |
| 场景节点 | `SceneNode.tsx` | 场景信息、GEO布局、视角预览 | ✅ |
| 分镜节点 | `ShotNode.tsx` | 分镜信息、景别、镜头运动、角色位置 | ✅ 生产Agent |
| 提示词节点 | `PromptNode.tsx` | Krea2/H3/QwenEdit提示词展示、复制 | ✅ 生产Agent |
| 编辑指令节点 | `EditNode.tsx` | 4步编辑流水线展示 | ✅ |
| ComfyUI任务节点 | `ComfyUITaskNode.tsx` | 任务提交、进度显示、结果预览 | ✅ 生产Agent |
...
| 生产Agent | `/production/generate-storyboard` | 生成分镜 | ShotNode |
